...
export const MOCK_TRIPS: Trip[] = [
  ...
  },
  {
    ...
    date_depart: new Date(now.getTime() + 9 * 24 * 60 * 60 * 1000).toISOString(),
    heure_depart: '14h00',
    lieu_depart: 'UdeM · Métro Université-de-Montréal',
    places_total: 4,
    places_restantes: 4,
    prix_par_personne: 18,
    organisateur_id: 'u4',
    description: 'Retour à la maison pour le weekend.',
    type: 'aller_simple',
    created_at: now.toISOString(),
  },
]
